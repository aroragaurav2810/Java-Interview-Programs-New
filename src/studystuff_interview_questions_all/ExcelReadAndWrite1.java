...
// The above line code is written because the excel was getting corrupted each time user reads its data 		
	...
	{
		file=new File("E:\\6 aug\\Interview Questions\\ExcelReadAndWrite1Output.xlsx");
		...
		int k=0;
			for(int i=0;i<data.length;i++)
			{
				...
				sheet=workbook.createSheet(""+list.get(k));		
	...
	{	
		ExcelReadAndWrite1 obj=new ExcelReadAndWrite1();
